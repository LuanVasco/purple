<template>
  <div class="bg-gray-300">
    ...
    <div class="container mx-auto pt-6 grid grid-cols-2">
      <!-- Image gallery -->
      <CarrouselProduct/>
      ...
      <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8">
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          ...
          <p class="text-3xl text-gray-900 my-4">
            R$ 192,99
          </p>
            ...
            <div class="mt-10">
              ...
              <fieldset class="mt-4">
                ...
                <div class="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                  ...
                  <label class="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-2 text-gray-200 cursor-not-allowed">
                  ...
                  <!-- Active: "ring-2 ring-indigo-500" -->
                  <label class="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-2 shadow-sm text-gray-900 cursor-pointer">
